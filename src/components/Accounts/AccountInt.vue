      ...
      <v-row dense>
        <v-col cols="4">
          <v-card
            ...
            class="cuadra"
          >
            <v-card-title class="headline">My applications</v-card-title>
        ...
        <v-col cols="4">
          <v-card
            ...
            class="cuadra"
          >
            <v-card-title class="headline">My personal information</v-card-title>
        ...
        <v-col cols="4">
          <v-card
            ...
            class="cuadra"
          >
            <v-card-title class="headline">My Documents</v-card-title>
