      ...
      <v-row dense>
        ...
        <v-col cols="4">
          <v-card
            ...
            class="cuadra"
          >
            <v-card-title class="headline">Mi Información</v-card-title>
        ...
        <v-col cols="4">
          <v-card
            ...
            class="cuadra"
          >
            <v-card-title class="headline">Programas Disponibles</v-card-title>
      ...
      <v-row dense>
        <v-col cols="4">
          <v-card
            ...
            class="cuadra"
          >
            <v-card-title class="headline">Postulaciones Disponibles</v-card-title>
        ...
        <v-col cols="4">
          <v-card
            ...
            class="cuadra"
          >
            <v-card-title class="headline">Becas y Financiamiento</v-card-title>
        ...
        <v-col cols="4">
          <v-card
            ...
            class="cuadra"
          >
            <v-card-title class="headline">Mis Documentos</v-card-title>
