  ...
  <div>
    <v-row align="center">
      ...
      <v-expansion-panels color="red" multiple v-model="panel">
        <v-expansion-panel>
          <v-expansion-panel-header>
            <v-alert color="blue" dark icon="mdi-bookmark-remove" dense>Programa X  </v-alert>
          </v-expansion-panel-header>
      ...
      >
        ...
        <v-expansion-panel>
          <v-expansion-panel-header>
            <v-alert color="green" dark icon="mdi-bookmark-remove" dense>Formularios Publicadas</v-alert>
          </v-expansion-panel-header>
          <v-expansion-panel-content>
                <v-list> 
      <v-list-item
