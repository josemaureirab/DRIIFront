    ...
    <v-dialog v-model="show" fullscreen hide-overlay transition="dialog-bottom-transition">
      <v-card>
        <v-toolbar dark color="primary">
          ...
          <v-toolbar-title>Nueva Pregunta con Archivo</v-toolbar-title>
          <v-spacer></v-spacer>
          <v-toolbar-items>
      ...
      <v-row>
        ...
        <v-list  three-line subheader >
          ...
          <v-list-item>
            ...
            <v-list-item-content>
              <v-list-item-title>Maximo de tamaño</v-list-item-title>
          ...
          <v-list-item>
            ...
            <v-list-item-content>
              <v-list-item-title>Extensiones permitidas</v-list-item-title>
              <v-list-item-subtitle> *pdf, *csv, ...</v-list-item-subtitle>
            </v-list-item-content>
          </v-list-item>
          <v-list-item>
            <v-list-item-action>
